export default function MentionsLegalesPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-8 pt-30">
      <h1 className="text-3xl font-bold mb-6">Mentions légales</h1>

      <section className="mb-6">
        <p>
          En conformité avec les articles 6-III et 19 de la Loi n°2004-575 du 21
          juin 2004 pour la Confiance dans l&apos;Économie Numérique (LCEN), il
      ...
      <section>
        ...
        <p>
          ...
          Mickael AGNIEL ne saurait être tenu responsable des erreurs ou
